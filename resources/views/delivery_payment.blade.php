            ...
            <div class="container">
                <div class="row pt-4">
                    ...
                    <div class="col-md-10 m-auto text__box p-4">
                        ...
                        <p>
                            В регионах доставка возможна силами курьерских компаний по согласованию.
                        </p>
                        ...
                        <p>
                            При 100% предоплате мы также отправляем заказы любыми транспортными компаниями, имеющими терминалы в
                            Москве (Деловые линии, ПЭК, ЖелДорЭкспедиция и другие).
                        </p>
                        <p>
                            Обращаем Ваше внимание на то, что в настоящий момент окончательная стоимость доставки рассчитывается менеджером при оформлении заказа.
                        </p>
                    </div>
                    <div class="col-md-10 m-auto text__box p-4 right text-right">
                        ...
                        <p>
                            Оплата наличными доступна для всех способов доставки – Вы можете оплатить заказ при получении у курьера, в пункте самовывоза.
                        </p>
