        ...
        <div class="row align-items-center">
            <div class="col-md-3 col-3 headerUnder__from  d-sm-none d-none d-md-block">
                <div class="headerUnder__from__city">
                    <img src="/img/icon/pin.png" alt=""> <a href="#" role="button" data-toggle="modal" data-target="#cityChoiceModal" onclick="$('#cityChoiceModal').modal()">Москва</a>
                </div>
            </div>
                ...
                <ul>
                    <li class="d-block d-md-none">
                        <div class="headerUnder__from__city">
                            ...
                            <a href="#" role="button" data-toggle="modal" data-target="#cityChoiceModal" onclick="$('#cityChoiceModal').modal()">Москва</a>
                        </div>
                    </li>
                    <li class="d-block d-md-none">
                        @guest
